	...
	public static void extract(File zipFile, File dir) throws IOException {
		...
		try {
			...
			if (!dir.exists() || !dir.isDirectory()) {
				throw new IOException("The directory is no a valid one: " + dir.getName() + ". Check if it exists and it is really a directory.");
			}
			...
			while (e.hasMoreElements()) {
				...
				try {	
					...
					int bytesRead = 0;
					if (is == null) {
						throw new ZipException("Error while reading zip entry: " + entry.getName());
					}
